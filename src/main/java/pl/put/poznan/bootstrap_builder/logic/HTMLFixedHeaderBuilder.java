 ...
 * @since 1.0
 */
public class HTMLFixedHeaderBuilder implements HTMLBuilder {
    /**
    ...
    /**
     * Creates a HTMLFixedHeaderBuilder
     * Inside creates new instance of StringBuilder and HTML class
     */
    public HTMLFixedHeaderBuilder() {
    ...
    /**
     * Method that adds head opening tag to skeleton and set it's position on fixed
     */
    @Override
